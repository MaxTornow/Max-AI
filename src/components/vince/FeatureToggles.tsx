      ...
      <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg space-y-3">
        ...
        {hookTitleEnabled && (
          <>
            ...
            />
            {hookTitleText.length > 40 && (
              <p className="text-xs text-amber-600 dark:text-amber-400">
                ⚠️ Hook text may wrap to a second line — only the first line will be highlighted. Keep it under 40 characters for best results ({hookTitleText.length}/60).
              </p>
            )}
